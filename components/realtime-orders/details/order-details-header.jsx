  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-2">
        ...
        {mobileDisplay ? (
          <a
            href={`tel:${mobileDigits.startsWith("966") ? "+" : ""}${mobileDigits}`}
    ...
    <>
            ...
            statuses.map((status) => {
              ...
              return (
                <DropdownMenuItem
                  ...
                  onSelect={() => {
                    if (active) return;
                    // Confirm before applying a status change (guards against misclicks).
      ...
      <ConfirmDialog
        ...
        onConfirm={() => {
          ...
          if (status) onStatusChange?.(order, status);
        }}
      />
    </>
  );
