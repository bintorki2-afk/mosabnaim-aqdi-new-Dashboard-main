...
export const SUMMARY_AGENT_FIELDS = [
  { key: "id_num_of_property_owner_agent", label: "رقم هوية الوكيل", type: "text", validation: "saudi_id" },
  {
  ...
  { key: "mobile_of_property_owner_agent", label: "جوال الوكيل", type: "text", validation: "saudi_mobile" },
  {
...
export const STEP4_FINANCIAL_FIELDS = [
  {
    ...
    label: "إجمالي قيمة الإيجار",
    type: "text",
    validation: "amount",
  },
  { key: "Guarantee_amount", label: "مبلغ الضمان", type: "text", validation: "amount" },
  { key: "deposit", label: "التأمين (العربون)", type: "text", validation: "amount" },
  { key: "daily_fine", label: "الغرامة اليومية", type: "text", validation: "amount" },
  {
    key: "payment_type_id",
    label: "نوع الدفع",
    type: "select",
